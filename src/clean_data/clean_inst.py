...
INST_FILE = Path("data/raw/Ins_2025-01_averaged.csv")
...
inst.to_csv('data/cleaned/inst_clean.csv', index=False, encoding='utf-8-sig', sep=";") # use -sig for Excel compatibility, add and strip out BOM
print(f"Instagram data cleaned")